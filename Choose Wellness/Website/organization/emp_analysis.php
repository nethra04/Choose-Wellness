    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="emp_analysis.php?eid=<?php echo $_GET["eid"]; ?>" class="nav-link active">
...
getData();*/
  ...
  function getData() {
    ...
    $.post('general_process.php', {'function' : 'graph_data_daily', 'eid' : '<?php echo $_GET["eid"]; ?>'}, 
    function(response) {
        response = JSON.parse(response);
        for(var i=0;i<response.length;i++){
            total_value = response.length;
